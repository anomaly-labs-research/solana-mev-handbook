...
- **jitoSOL** — the stake pool routes to validators running the Jito client, which auctions block space to searchers. 95% of those **MEV tips** flow back to jitoSOL holders. Through 2026 jitoSOL's blended yield has ranged roughly 5.9% to 7.5% depending on how busy the chain is; MEV is the swing factor.
...
| **Oracle** | Protocol prices collateral wrong; attacker borrows against inflated value | Mango Markets, Oct 2022, $116M (MNGO pumped 2,300% on thin venues); Solend isolated pools, Nov 2022, $1.26M bad debt; Loopscale RateX PT feed, Apr 2025, $5.8M (12% of TVL, returned within 72h) |
...
| **Liquidity / exit** | You can't withdraw when you want | Lending pool at 97% utilization; LST unstake queue of one epoch (~2 days) during a depeg; CL position stranded out of range |
